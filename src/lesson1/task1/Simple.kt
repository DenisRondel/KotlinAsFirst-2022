 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double =  (deg + sec.toDouble()/3600 + min.toDouble()/60)* PI/ 180 // дорешать
 ...
 */
fun thirdDigit(number: Int): Any =
    if (number>99) {
        val number = number%1000
        number/100
    } else print("а так делать нельзя :)")
